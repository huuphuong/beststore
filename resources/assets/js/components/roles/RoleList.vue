							...
							<div class="dropdown">
								<button class="btn btn-link dropdown-toggle" type="button" data-toggle="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<router-link :to="{name: 'RoleEdit'}" tag="li">
											<a><i class="mdi mdi-pencil"></i> Edit Role</a>
										</router-link>

										<router-link :to="{name: 'RoleEdit'}" tag="li">
											<a><i class="mdi mdi-window-close"></i> Delete Role</a>
										</router-link>

										<router-link :to="{name: 'RoleDetail', params: {id: role.id} }" tag="li">
											<a><i class="mdi mdi-eye"></i> View Role Detail</a>
										</router-link>
									</ul>
								</div>
							</td>
