...
import CollectionEdit from '../components/products/CollectionEdit.vue';
...
import VendorEdit from '../components/vendors/VendorEdit.vue';
...
export default new VueRouter({
	...
	routes: [
		...
		{ path: '/collections/:id', name: 'CollectionEdit', component: CollectionEdit },
		...
		{ path: '/vendors/edit/:id', name: 'VendorEdit', component: VendorEdit },
	],
	mode: 'history'
})
